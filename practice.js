...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  for (let i = 0; i < pieQuantity; i++) {
    // call to the helper to print ingredients and number of pie
    printIngredents(pieType, recipe, i);
  }

  // calculate and print price of the pie
  const costOfPie = pieCost(recipe);

  // calculate total cost and print revenue
  printTotalRevenue(costOfPie, pieQuantity, profitMargin);
}

function printIngredents(pieType, recipe, i) {
...
function printTotalRevenue(costOfPie, pieQuantity, profitMargin) {
